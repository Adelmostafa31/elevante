...
class ResponseCode {
  ...
  static const int BAD_elevante = 400; // failure, API rejected elevante
  static const int UNAUTORISED = 401; // failure, user is not authorised
  static const int FORBIDDEN = 403; //  failure, API rejected elevante
...
class ResponseMessage {
  ...
  static const String BAD_elevante =
      ApiErrors.badelevanteError; // failure, API rejected elevante
  static const String UNAUTORISED =
      ApiErrors.unauthorizedError; // failure, user is not authorised
  static const String FORBIDDEN =
      ApiErrors.forbiddenError; //  failure, API rejected elevante
...
extension DataSourceExtension on DataSource {
  ApiErrorModel getFailure() {
    switch (this) {
      ...
      case DataSource.BAD_elevante:
        return ApiErrorModel(
            code: ResponseCode.BAD_elevante,
            message: ResponseMessage.BAD_elevante);
